...
TvShowsResponse tvShowsResponseFromJson(String str) =>
    TvShowsResponse.fromJson(json.decode(str));
...
TvResults resultsFromJson(String str) => TvResults.fromJson(json.decode(str));
